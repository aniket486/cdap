...
public class ProvisionTask implements Runnable {
  ...
  public void run() {
    ...
    try {
      ...
      LOG.debug("Provision task for program run {} interrupted.", programRunId);
  ...
  private void createCluster(ProvisioningTaskInfo taskInfo) throws InterruptedException {
    Cluster cluster;
  ...
  private void deleteCluster(ProvisioningTaskInfo taskInfo) throws InterruptedException {
    try {
  ...
  private void pollForCreate(ProvisioningTaskInfo taskInfo) throws InterruptedException {
    try {
  ...
  private void pollForDelete(ProvisioningTaskInfo taskInfo) throws InterruptedException {
    try {
  ...
  private void initializeCluster(ProvisioningTaskInfo taskInfo) throws InterruptedException {
    try {
      Retries.callWithRetries(() -> {
